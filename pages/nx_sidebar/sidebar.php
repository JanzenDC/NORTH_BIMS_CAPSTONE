        ...
        <ul>
            ...
            <li>
                ...
                <ul id="settings-menu-2" class="hidden ">
                    ...
                    <li>
                        <a href="../nx_pages/BarangayCertificates.php?page=land" class="<?php echo $treeView == 'land' ? 'active:bg-green-400 text-white' : ''; ?> block px-4 py-2 hover:bg-gray-300 hover:text-black">
