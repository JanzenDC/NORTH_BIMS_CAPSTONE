...
<div class="p-3 w-full bg-white">
    <h1 class="text-3xl font-bold">Purok Leader</h1>
    <hr>
...
<div id="createModal" class="modal fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center hidden">
    <div class="bg-white rounded-lg shadow-lg p-6 w-1/3">
        ...
        <form id="createForm" enctype="multipart/form-data" onsubmit="event.preventDefault(); addRecord();">
            ...
            <input type="text" name="purok" id="addPurok" placeholder="Purok" class="block w-full mb-2 p-2 border rounded" required>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 w-1/3">
        ...
        <form id="editForm" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <input type="text" id="editPurok" name="purok" placeholder="Purok" class="block w-full p-2 border rounded" required>
...
function deleteRecord(id) {
    swal({
        ...
        if (willDelete) {
            $.ajax({
                url: 'nx_query/manage_puroklead.php?action=delete&id=' + id,
                type: 'DELETE',
...
function updateRecord(event) {
    ...
    const purok = document.getElementById('editPurok').value;
    ...
    $.ajax({
        url: 'nx_query/manage_puroklead.php?action=update',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
function addRecord() {
    ...
    $.ajax({
        url: 'nx_query/manage_puroklead.php?action=create',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
