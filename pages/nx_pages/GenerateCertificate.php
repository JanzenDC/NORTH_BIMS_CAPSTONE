...
$valid_pages = ['generate_clearance', 'generate_indigency', 'generate_residency', 'generate_bpermit', 'bilihannglupa', 'bilihan_ng_hayop', 'bilihanngsasakyan', 'generate_blotter']; // Add other valid pages here
