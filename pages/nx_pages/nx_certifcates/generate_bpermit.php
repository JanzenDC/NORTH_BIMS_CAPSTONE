...
// QUERY
$sqlQuery = "SELECT * FROM business_cert WHERE id = '$id'";
$result = mysqli_query($conn, $sqlQuery);

if ($result && mysqli_num_rows($result) > 0) {
    $row = mysqli_fetch_assoc($result);
    $fullname = $row['owner_fname'] . " " . $row['owner_mname'] . " " . $row['owner_lname'];
}
          ...
          <div style="position: relative; width: 816px; height: 1056px; background: white; overflow: hidden;">
            ...
            <div style="display: flex; justify-content: center; margin-top: 8px;">
              <h1 style="font-weight: 600;">
                ...
                <div style="margin-top: 30px; text-align: center;">BUSINESS CERTIFICATION</div>
              </h1>
            </div>
            ...
            <div style="margin-left: 90px; margin-right: 90px;">
              ...
              <div style="margin-top: 12px; word-spacing: 4.3px;">
                <span style="margin-left: 50px;"></span>This is to certify that
                <b><?= $fullname ?></b>&nbsp; resident of North Poblacion,
                Gabaldon,Nueva Ecija as owner of a
                <b><?= $row['businessName'] ?></b> located at Barangay
                <u style="font-weight: bold;">NORTH POBLACION</u>, Gabaldon,Nueva Ecija.
              </div>

              <div style="margin-top: 10px;">
                <span style="margin-left: 50px;"></span> This Certitification has been
                granted upon request of the interested party for what ever legal
                purposes it may serve.
              </div>
              
              <div style="margin-top: 10px;">
                <span style="margin-left: 50px;"></span> Issued this <?php $day?><sup><? $suffix ?></sup> day
                of <?= $month?> <?= $year ?> here at Barangay North Poblacion Gabaldon Nueva
                Ecija.
              </div>
              
              <div style="display: grid; grid-template-columns: 1fr 1fr; margin-top: 30px; text-align: center;">
                <div>
                  <div>Prepared by:</div>
                  <div style="margin-top: 30px;">
                    <b>SHERLITA C. CALUDUCAN</b> <br />
                    <span style="font-size: 14px;">Barangay Secretary</span>
                  </div>
                </div>
                <div>
